    ...
    <div className="min-h-screen bg-gray-50 flex justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="bg-gradient-to-r from-teal-600 to-blue-600 px-6 py-8 text-center">
          ...
          >
            <FaCheckCircle className="h-16 w-16 text-teal-600" />
          </motion.div>
          <motion.h1 
        ...
        <div className="px-6 py-8">
          ...
          >
            ...
            >
              <FaHome className="h-8 w-8 text-teal-600 mb-2" />
            ...
            <Link 
              ...
              className="flex flex-col items-center justify-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
            >
              <FaUser className="h-8 w-8 text-teal-600 mb-2" />
          ...
          >
            <Link 
              to="/nos-produits"
              className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gradient-to-r from-teal-600 to-blue-600 hover:from-teal-700 hover:to-blue-700 shadow-sm"
            >
