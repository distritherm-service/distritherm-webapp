    ...
    const loadQuotes = async () => {
      ...
      try {
        ...
        const transformedQuotes: Quote[] = response.devis.map(apiQuote => ({
          ...
          items: apiQuote.cart && apiQuote.cart.cartItems ? apiQuote.cart.cartItems.map(item => ({
            id: item.id,
      ...
      <>
        ...
        <section className="relative h-64 md:h-80 lg:h-[420px] w-full overflow-hidden shadow-md">
          ...
          <div className="absolute inset-0">
            <img
              src="/femme-faisant-de-la-comptabilite.jpg"
              alt="Femme faisant de la comptabilité"
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
            <h1 className="text-4xl md:text-6xl lg:text-6xl font-extrabold text-white drop-shadow-lg mb-4 tracking-tight">Mes devis</h1>
            <Breadcrumb />
          </div>
