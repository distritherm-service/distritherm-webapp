        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          >
            <div className="text-center mb-8">
              <div className="mx-auto h-16 w-16 bg-[#7CB9E8] rounded-full flex items-center justify-center">
            ...
            {(status === 'sent' || status === 'verified') && message && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className="rounded-md bg-yellow-50 p-4 mb-4"
              >
                <div className="flex">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <button
                ...
                className="w-full flex justify-center items-center py-3 px-4 border border-[#007FFF] rounded-md shadow-sm text-sm font-medium text-[#007FFF] bg-white hover:bg-[#7CB9E8] hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#007FFF]"
              >
                Retour au profil
              </button>
            </div>
