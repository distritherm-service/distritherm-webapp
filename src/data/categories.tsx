...
export const categories = [
  {
    title: 'PLATERIE',
    image: '/src/assets/platerie.jpeg',
    icon: (
  ...
  {
    title: 'CLIMATISATION',
    image: '/src/assets/climatisation.jpeg',
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    title: 'ISOLATION',
    image: '/src/assets/isolation.jpeg',
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    title: 'SANITAIRE',
    image: '/src/assets/sanitaire.jpeg',
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    title: 'ÉLECTRICITÉ',
    image: '/src/assets/electricite.jpeg',
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    title: 'OUTILLAGE',
    image: '/src/assets/outillage.jpeg',
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
